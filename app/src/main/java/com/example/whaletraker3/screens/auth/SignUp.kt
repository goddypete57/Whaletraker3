...
onBackPress:()->Unit={}
    ...
    Box(
        ...
        Column(
            ...
            Text(textAlign = TextAlign.Start,
                text = "Create a pennytracker account to get started",
                fontSize = 16.sp,
                fontWeight = FontWeight.Medium,
                color = SubText)
            ...
            Text(textAlign = TextAlign.Center,
                text = buildAnnotatedString {
                    withStyle(style = SpanStyle(fontSize = 15.sp, fontWeight = FontWeight.Medium, color = SubText)) {
                    ...
                    withStyle(style = SpanStyle(fontSize = 15.sp, fontWeight = FontWeight.Medium, color = SubText)) {
                        append(" of whale tracker")
                    }
                }
            )
            Spacer(modifier = Modifier.size(193.dp))
            Row(
                ...
                Text(text = "I already have an account?",
                    ...
                    color = SubText)
                ClickableText(text = AnnotatedString("Log in"),
                    onClick = {
                              onLogin.invoke()
                    },
